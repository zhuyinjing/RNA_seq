  ...
  <div class="content">
    ...
    <div class="container">
      <el-row>
        ...
        <!-- <div id="microarrays_dendrogram" class="" style="display:inline-block;width:60%;vertical-align:top"></div>
        <div id="microarrays" class="" style="display:inline-block;width:30%;vertical-align:top;margin-top:200px;">
            <div id="boxplot" ></div>
        </div> -->
    </div>
</div>
