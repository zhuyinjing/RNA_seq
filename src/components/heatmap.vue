<template>
  <div class="content">
    ...
    <div class="container">
    <div id="microarrays_dendrogram" class="col-md-8"></div>
    <div id="microarrays" class="col-md-4">
        <div id="boxplot"></div>
    </div>
</div>
<div id="container">
...
import Kinetic from 'kinetic/kinetic.min.js'
export default {
  data () {
    return {
    }
  ...
  mounted () {
    ...
    window.boxplot = new Highcharts.Chart({
            ...
            function draw_boxplot(object_ids, column_ids, y){
                ...
                console.log("BBB:" + JSON.stringify(class2values));
                ...
                for (i = 0; i < object_ids.length; i++) {
                    ...
                    console.log("CCC:" + JSON.stringify(current_columns));
                    for (j = 0; j < current_columns.length; j++) {
                        key = current_columns[j];
                        console.log("EEE:" + i + ":" + key + ", " + column_metadata[key]);
                        class2values[column_metadata[key]].push(values[key]);
                    }
                }

                console.log("DDD:" + JSON.stringify(class2values));
                ...
                console.log("FFF:" + JSON.stringify(seriesData));
